...
static const int window_w = 1500;
      ...
      if (event.type == sf::Event::Closed) {
        ...
        if (keycode == sf::Keyboard::Escape) {
          ...
          break;
            ...
            universe.SetPopulation(20, 1000);
            universe.ReSeed(0.045f, 0.03f, 0.0f, 30.0f, 30.0f, 80.0f, 0.03f, false);
        } else if (keycode == sf::Keyboard::T) { //Ben's Test
                universe.SetPopulation(12, 4000);
                universe.ReSeed(0.02f, 0.06f, 0.0f, 25.0f, 50.0f, 120.0f, 0.05f, false);
        } else if (keycode == sf::Keyboard::B) { //Balanced
          universe.SetPopulation(9, 1000);
